								              ...
								              std::vector<glm::mat4> &Offsets)
{
	...
	sAnimationInfo animInfo =  this->mapAnimationFriendlyNameTo_pScene[animationName];
	...
	//float TicksPerSecond = this->pScene->mAnimations[0]->mTicksPerSecond;
	float TicksPerSecond = animInfo.pAIScene->mAnimations[0]->mTicksPerSecond;
	float TimeInTicks = TimeInSeconds * TicksPerSecond;
	//float TimeInTicks = TimeInSeconds;
	//float TimeInTicks = TicksPerSecond;
	//float TimeInTicks = Tick;
	...
	float AnimationTime = fmod(TimeInTicks, (float)animInfo.pAIScene->mAnimations[0]->mDuration);
	//float AnimationTime = fmod(TimeInTicks, 163.0f);
